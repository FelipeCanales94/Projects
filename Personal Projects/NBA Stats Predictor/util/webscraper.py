...
def getTeamStats(team_name):
    ...
    url = 'https://www.basketball-reference.com/teams/{}/2023.html'.format(team_abbreviations.get(team_name))

    
    createFolder('../' + team_name + '/team_stats')  # creates new directory using team's name if it doesn't exist
    directory_name = pjoin('../' + team_name + '/team_stats', str('season_stats' + '.csv'))  # puts csv in team directory
...
def individualStats(player_name):
    ...
    url = 'https://www.basketball-reference.com/players/{}/{}/gamelog/2022'.format(player_abb[0], player_abb)
...
def getTeamRoster(team_name):
    if team_name in team_abbreviations:  # Make sure it's a valid NBA team
        ...
        directory = '../data/' + team_name_fixed + '/' + team_name_fixed + '_roster.csv'  # directory to write csv

        # start web scraping
        url = 'https://www.basketball-reference.com/teams/{}/2022.html'.format(team_abbreviations.get(team_name))
